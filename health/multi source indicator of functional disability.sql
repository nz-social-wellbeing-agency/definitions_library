...
## Outputs
Table: [IDI_Sandpit].[DL-MAA2021-49].[defn_functional_disability]
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2021-49].[defn_functional_disability]
GO
...
INTO [IDI_Sandpit].[DL-MAA2021-49].[defn_functional_disability]
FROM most_recent_date
WHERE ranking = 1
GO

CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA2021-49].[defn_functional_disability] (snz_uid);
GO
ALTER TABLE [IDI_Sandpit].[DL-MAA2021-49].[defn_functional_disability] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)
GO
