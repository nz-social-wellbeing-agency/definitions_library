...
Outputs:
- [IDI_UserCode].[DL-MAA2020-01].[d2g_corrections_prison]
...
/* Clear existing view */
IF OBJECT_ID('[DL-MAA2020-01].[d2g_corrections_prison]','V') IS NOT NULL
DROP VIEW [DL-MAA2020-01].[d2g_corrections_prison];
GO

/* Create view */
CREATE VIEW [DL-MAA2020-01].[d2g_corrections_prison] AS
SELECT a.snz_uid
