...
Outputs:
- [IDI_UserCode].[DL-MAA2021-60].[defn_corrections_any]
...
7) IDI metadata: There are major management period start dates from 1882, however consistent 
...
2022-05-17 VW Point to DL-MAA2018-48, update to latest refresh (202203)
2022-02-18 PM Point to DL-MAA2021-60, update to latest refresh
...
/* Clear existing view */
IF OBJECT_ID('[DL-MAA2018-48].[defn_corrections_any]','V') IS NOT NULL
DROP VIEW [DL-MAA2018-48].[defn_corrections_any];
GO

/* Create view */
CREATE VIEW [DL-MAA2018-48].[defn_corrections_any] AS
SELECT a.snz_uid
