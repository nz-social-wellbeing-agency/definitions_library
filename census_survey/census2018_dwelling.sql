/**************************************************************************************************
Title: Census 2018 dwelling conditions
Author: Penny Mok
...
Description:
Describe the dwelling condition of household.

Intended purpose:
A proxy for dwelling condition using census data.

Inputs & Dependencies:
- [IDI_Clean].[cen_clean].[census_dwelling_2018]
Outputs:
- [IDI_UserCode].[DL-MAA20XX-YY].[defn_cen18_dwelling]
...
/* Clear existing view */
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[defn_cen18_dwelling];
GO

/* Create view */
CREATE VIEW [DL-MAA20XX-YY].[defn_cen18_dwelling] AS (
SELECT snz_uid
      ,a.[snz_cen_dwell_uid]
...
FROM [IDI_Clean_YYYYMM].[cen_clean].[census_dwelling_2018] a
INNER JOIN [IDI_Clean_YYYYMM].[cen_clean].[census_household_2018] b
ON a.snz_cen_dwell_uid=b.snz_cen_dwell_uid
INNER JOIN [IDI_Clean_YYYYMM].[cen_clean].[census_individual_2018] c 
