...
Outputs:
- [IDI_UserCode].[DL-MAA2020-01].[d2g_main_benefit_types]
...
IF OBJECT_ID('[DL-MAA2020-01].[d2g_main_benefit_types]','V') IS NOT NULL
DROP VIEW [DL-MAA2020-01].[d2g_main_benefit_types];
GO

CREATE VIEW [DL-MAA2020-01].[d2g_main_benefit_types] AS
