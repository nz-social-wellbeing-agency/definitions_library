...
Description:
Ambulatory sensitive hospitalisations (ASH) & Child ASH & Potentially Avoidable Hospitalisation (PAH)

Intended purpose:
This code defines spells where clients have had a publicly funded hospital event which is considered
...
/* Add index */
CREATE CLUSTERED INDEX my_index_name ON [IDI_Sandpit].[$(PROJSCH)].[$(TBLPREF)_ash_event] ([moh_dia_event_id_nbr]);
GO
...
/* Add index */
CREATE CLUSTERED INDEX my_index_name ON [IDI_Sandpit].[$(PROJSCH)].[$(TBLPREF)_ash] ([snz_uid]);
GO
