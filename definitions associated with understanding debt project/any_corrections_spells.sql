...
Outputs:
- [IDI_UserCode].[DL-MAA2020-01].[d2g_corrections_any]
...
/* Clear existing view */
IF OBJECT_ID('[DL-MAA2020-01].[d2g_corrections_any]','V') IS NOT NULL
DROP VIEW [DL-MAA2020-01].[d2g_corrections_any];
GO

/* Create view */
CREATE VIEW [DL-MAA2020-01].[d2g_corrections_any] AS
SELECT a.snz_uid
