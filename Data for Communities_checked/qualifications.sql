...
Outputs:
- [IDI_UserCode].[DL-MAA2016-15].[defn_qualification_awards]
...
/* Clear view */
IF OBJECT_ID('[DL-MAA2016-15].[defn_qualification_awards]','V') IS NOT NULL
DROP VIEW [DL-MAA2016-15].[defn_qualification_awards];
GO

CREATE VIEW [DL-MAA2016-15].[defn_qualification_awards] AS
...
SELECT [snz_uid]
	  ...
	  ,'cen2018' AS [source]
FROM [IDI_Clean_20200120].[cen_clean].[census_individual_2018]
...
SELECT [snz_uid]
	...
	,'cen2013' AS [source]
FROM [IDI_Clean_20200120].[cen_clean].[census_individual_2013]
...
SELECT snz_uid
		...
		,'second' AS [source]
FROM [IDI_Clean_20200120].[moe_clean].[student_qualification]
...
SELECT snz_uid
		...
		,'tertiary' AS [source]
FROM [IDI_Clean_20200120].[moe_clean].[completion]
