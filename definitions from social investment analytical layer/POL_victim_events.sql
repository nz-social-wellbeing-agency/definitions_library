/**************************************************************************************************
Title: Police victim events
Author: K Maxwell

Inputs & Dependencies:
- [IDI_Clean].[pol_clean].[pre_count_victimisations]
Outputs:
- [IDI_UserCode].[DL-MAA2016-15].[sial_POL_victim_events]
...
IF OBJECT_ID('[DL-MAA2016-15].[sial_POL_victim_events]','V') IS NOT NULL
DROP VIEW [DL-MAA2016-15].[sial_POL_victim_events];
GO

CREATE VIEW [DL-MAA2016-15].[sial_POL_victim_events] AS
...
FROM [IDI_Clean_20200120].[pol_clean].[pre_count_victimisations]
GO