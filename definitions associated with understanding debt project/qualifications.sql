...
Outputs:
- [IDI_UserCode].[DL-MAA2020-01].[d2g_qualification_awards]
...
/* Clear view */
IF OBJECT_ID('[DL-MAA2020-01].[d2g_qualification_awards]','V') IS NOT NULL
DROP VIEW [DL-MAA2020-01].[d2g_qualification_awards];
GO

CREATE VIEW [DL-MAA2020-01].[d2g_qualification_awards] AS
